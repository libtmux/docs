...
<!-- port:py -->document the Python reference grammar and identify proposed native extensions.
<!-- /port --><!-- port:ts,rs,go,java,dotnet,cxx,swift -->document the Python reference grammar and identify native extensions.
<!-- /port -->
## Commands
...
<!-- port:py -->described by their own flags. The proposed native command tree adds `--json` and
<!-- /port --><!-- port:ts,rs,go,java,dotnet,cxx,swift -->described by their own flags. The native command tree adds `--json` and
<!-- /port -->`--ndjson` to every leaf and allows these long options before or after the
