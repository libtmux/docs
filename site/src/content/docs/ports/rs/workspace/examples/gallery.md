...
Accepted by the native parser in the 2026-09-09 audit. unsupported=["options_after"] Full execution of this fixture was not established by the parser result.
...
Accepted by the native parser in the 2026-09-09 audit. unsupported=[] Full execution of this fixture was not established by the parser result.
...
Rejected by the native parser in the 2026-09-09 audit. workspace configuration is invalid: windows[0].panes[0] must be a command string or a mapping Full execution of this fixture was not established by the parser result.
...
Accepted by the native parser in the 2026-09-09 audit. unsupported=["before_script"] Full execution of this fixture was not established by the parser result.
...
Accepted by the native parser in the 2026-09-09 audit. unsupported=["shell", "shell", "shell"] Full execution of this fixture was not established by the parser result.
...
Accepted by the native parser in the 2026-09-09 audit. unsupported=["plugins"] Full execution of this fixture was not established by the parser result.
...
Rejected by the native parser in the 2026-09-09 audit. workspace configuration is invalid: shell_command entries must be strings Full execution of this fixture was not established by the parser result.
