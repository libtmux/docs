...
tmuxp's workspace APIs are part of the `tmuxp` package. They use libtmux's
`Server`, `Session`, `Window`, and `Pane` objects for actual tmux control.
