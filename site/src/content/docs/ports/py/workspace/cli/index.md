...
document the Python reference grammar and identify proposed native extensions.
...
described by their own flags. The proposed native command tree adds `--json` and
