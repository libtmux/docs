...
This command remains Python-specific even when reached through a future native
command.
...
PTPython. The compatibility proposal uses an optional version-checked Python
