...
export const CONCEPTS: Record<string, Concept> = {
  ...
  'session-option': {
    ...
    symbols: {
      ...
      rs: 'session.Session.typed_option',
  ...
  'list-buffers': {
    ...
    symbols: {
      ...
      dotnet: 'LibTmux.TmuxBuffers.GetAllAsync',
  ...
  'show-buffer': {
    ...
    symbols: {
      ...
      dotnet: 'LibTmux.TmuxBuffers.GetAsync',
  ...
  'set-buffer': {
    ...
    symbols: {
      ...
      dotnet: 'LibTmux.TmuxBuffers.SetAsync',
  ...
  'delete-buffer': {
    ...
    symbols: {
      ...
      dotnet: 'LibTmux.TmuxBuffers.DeleteAsync',
  ...
  'load-buffer': {
    ...
    symbols: {
      ...
      dotnet: 'LibTmux.TmuxBuffers.LoadAsync',
  ...
  'save-buffer': {
    ...
    symbols: {
      ...
      dotnet: 'LibTmux.TmuxBuffers.SaveAsync',
  ...
  'list-keys': {
    ...
    symbols: {
      ...
      java: 'io.github.libtmux.Keys.Keys.list',
      dotnet: 'LibTmux.TmuxKeys.GetAllAsync',
    },
    absent: {
  ...
  'bind-key': {
    ...
    symbols: {
      ...
      java: 'io.github.libtmux.Keys.Keys.bind',
      dotnet: 'LibTmux.TmuxKeys.BindAsync',
  ...
  'unbind-key': {
    ...
    symbols: {
      ...
      java: 'io.github.libtmux.Keys.Keys.unbind',
      dotnet: 'LibTmux.TmuxKeys.UnbindAsync',
  ...
  'raise-if-dead': {
    ...
    symbols: {
      ...
      go: 'tmux.Server.CheckAlive',
      java: 'io.github.libtmux.Server.Server.requireAlive',
      dotnet: 'LibTmux.Server.ThrowIfDeadAsync',
    },
    absent: {
      rs: 'no equivalent on `Server`',
      cxx: 'no equivalent on `Server`',
...
/**
 * Ruby and Lua joined after the original eight-port table was written.
 * Keep their reviewed bindings together: it makes the source audit legible,
 * and the completion loop below turns every unreviewed concept into an
 * explicit absence instead of a guessed name match.
 */
const RUBY_CONCEPTS: Record<string, string> = {
  'workspace-description': 'LibTmux::Workspace',
  'build-workspace': 'LibTmux::Workspace::Plan#apply',
  server: 'LibTmux::Server',
  session: 'LibTmux::Session',
  window: 'LibTmux::Window',
  pane: 'LibTmux::Pane',
  'capture-pane': 'LibTmux::Pane#capture',
  'send-keys': 'LibTmux::Pane#send_keys',
  'split-pane': 'LibTmux::Pane#split',
  'split-window': 'LibTmux::Window#split',
  'respawn-pane': 'LibTmux::Pane#respawn',
  'select-layout': 'LibTmux::Window#select_layout',
  'source-file': 'LibTmux::Server#source_file',
  'list-clients': 'LibTmux::Server#list_clients',
  'new-session': 'LibTmux::Server#new_session',
  'new-window': 'LibTmux::Session#new_window',
  'kill-server': 'LibTmux::Server#kill',
  'list-sessions': 'LibTmux::Server#list_sessions',
  'kill-session': 'LibTmux::Session#kill',
  'kill-window': 'LibTmux::Window#kill',
  'kill-pane': 'LibTmux::Pane#kill',
  'rename-session': 'LibTmux::Session#rename',
  'rename-window': 'LibTmux::Window#rename',
  'select-pane': 'LibTmux::Pane#select',
  'resize-pane': 'LibTmux::Pane#resize',
  'list-windows': 'LibTmux::Session#list_windows',
  'list-panes': 'LibTmux::Window#list_panes',
  'list-session-panes': 'LibTmux::Session#list_panes',
  'list-server-windows': 'LibTmux::Server#list_windows',
  'list-server-panes': 'LibTmux::Server#list_panes',
  'server-options': 'LibTmux::Server#options',
  'session-options': 'LibTmux::Session#options',
  'window-options': 'LibTmux::Window#options',
  'pane-options': 'LibTmux::Pane#options',
  'server-hooks': 'LibTmux::Server#hooks',
  'session-hooks': 'LibTmux::Session#hooks',
  'window-hooks': 'LibTmux::Window#hooks',
  'pane-hooks': 'LibTmux::Pane#hooks',
  'server-environment': 'LibTmux::Server#environment',
  'session-environment': 'LibTmux::Session#environment',
  'set-server-environment': 'LibTmux::Server#set_environment',
  'set-session-environment': 'LibTmux::Session#set_environment',
  'unset-server-environment': 'LibTmux::Server#unset_environment',
  'unset-session-environment': 'LibTmux::Session#unset_environment',
  'list-buffers': 'LibTmux::Server#list_buffers',
  'show-buffer': 'LibTmux::Server#read_buffer',
  'set-buffer': 'LibTmux::Server#write_buffer',
  'delete-buffer': 'LibTmux::Server#delete_buffer',
  'run-shell': 'LibTmux::Server#run',
  snapshot: 'LibTmux::Server#snapshot',
  'server-cmd': 'LibTmux::Server#run',
  'wait-for': 'LibTmux::Server#wait_for',
  'get-session': 'LibTmux::Server#session',
  'get-window': 'LibTmux::Server#window',
  'get-pane': 'LibTmux::Server#pane',
  'search-server-panes': 'LibTmux::Server#search_panes',
  'session-id': 'LibTmux::SessionSnapshot#id',
  'window-id': 'LibTmux::WindowSnapshot#id',
  'pane-id': 'LibTmux::PaneSnapshot#id',
  'session-name': 'LibTmux::SessionSnapshot#name',
  'window-name': 'LibTmux::WindowSnapshot#name',
  'window-index': 'LibTmux::WindowLinkSnapshot#index',
  'pane-index': 'LibTmux::PaneSnapshot#index',
  'window-height': 'LibTmux::WindowSnapshot#height',
  'window-width': 'LibTmux::WindowSnapshot#width',
  'pane-height': 'LibTmux::PaneSnapshot#height',
  'pane-width': 'LibTmux::PaneSnapshot#width',
  'pane-title': 'LibTmux::PaneSnapshot#title',
  'window-active': 'LibTmux::WindowLinkSnapshot#active?',
  'pane-active': 'LibTmux::PaneSnapshot#active?',
  'session-attached': 'LibTmux::SessionSnapshot#attached',
  'session-created': 'LibTmux::SessionSnapshot#created',
  'session-window-count': 'LibTmux::SessionSnapshot#window_count',
  'pane-current-command': 'LibTmux::PaneSnapshot#current_command',
  'pane-current-path': 'LibTmux::PaneSnapshot#current_path',
  'pane-window-id': 'LibTmux::PaneSnapshot#window_id',
  'pane-window': 'LibTmux::PaneSnapshot#window',
  'session-server': 'LibTmux::Session#server',
  'window-server': 'LibTmux::Window#server',
  'pane-server': 'LibTmux::Pane#server',
  'session-active-pane': 'LibTmux::WindowSnapshot#active_pane',
  'resize-window': 'LibTmux::Window#resize',
  'respawn-window': 'LibTmux::Window#respawn',
  'link-window': 'LibTmux::Session#link_window',
  'break-pane': 'LibTmux::Pane#break_out',
  'join-pane': 'LibTmux::Pane#join',
  'move-pane': 'LibTmux::Pane#move',
  'swap-pane': 'LibTmux::Pane#swap',
  'pipe-pane': 'LibTmux::Pane#pipe',
  'copy-mode': 'LibTmux::Pane#copy_mode',
}

const LUA_CONCEPTS: Record<string, string> = {
  server: 'libtmux.Server',
  session: 'libtmux.SnapshotSession',
  window: 'libtmux.SnapshotWindow',
  pane: 'libtmux.SnapshotPane',
  'capture-pane': 'libtmux.Entity:capture',
  'send-keys': 'libtmux.Entity:send_keys',
  'split-pane': 'libtmux.Entity:split',
  'respawn-pane': 'libtmux.Entity:respawn',
  'clear-history': 'libtmux.Entity:clear_history',
  'set-pane-title': 'libtmux.Entity:set_title',
  'paste-buffer': 'libtmux.Entity:paste_buffer',
  'select-layout': 'libtmux.Entity:layout',
  'unlink-window': 'libtmux.Entity:unlink',
  'new-session': 'libtmux.Server:new_session',
  'new-window': 'libtmux.Entity:new_window',
  'kill-session': 'libtmux.Entity:kill',
  'kill-window': 'libtmux.Entity:kill',
  'kill-pane': 'libtmux.Entity:kill',
  'rename-session': 'libtmux.Entity:rename',
  'rename-window': 'libtmux.Entity:rename',
  'select-window': 'libtmux.Entity:select',
  'select-pane': 'libtmux.Entity:select',
  'resize-pane': 'libtmux.Entity:resize',
  'list-sessions': 'libtmux.Snapshot.sessions',
  'list-server-windows': 'libtmux.Snapshot.windows',
  'list-server-panes': 'libtmux.Snapshot.panes',
  'server-option': 'libtmux.Server:get_option',
  'session-option': 'libtmux.Entity:get_option',
  'window-option': 'libtmux.Entity:get_option',
  'pane-option': 'libtmux.Entity:get_option',
  'set-server-option': 'libtmux.Server:set_option',
  'set-session-option': 'libtmux.Entity:set_option',
  'set-window-option': 'libtmux.Entity:set_option',
  'set-pane-option': 'libtmux.Entity:set_option',
  'unset-server-option': 'libtmux.Server:unset_option',
  'unset-session-option': 'libtmux.Entity:unset_option',
  'unset-window-option': 'libtmux.Entity:unset_option',
  'unset-pane-option': 'libtmux.Entity:unset_option',
  'server-hooks': 'libtmux.Server:list_hooks',
  'session-hooks': 'libtmux.Entity:list_hooks',
  'window-hooks': 'libtmux.Entity:list_hooks',
  'pane-hooks': 'libtmux.Entity:list_hooks',
  'set-server-hook': 'libtmux.Server:set_hook',
  'set-session-hook': 'libtmux.Entity:set_hook',
  'set-window-hook': 'libtmux.Entity:set_hook',
  'set-pane-hook': 'libtmux.Entity:set_hook',
  'unset-server-hook': 'libtmux.Server:unset_hook',
  'unset-session-hook': 'libtmux.Entity:unset_hook',
  'unset-window-hook': 'libtmux.Entity:unset_hook',
  'unset-pane-hook': 'libtmux.Entity:unset_hook',
  'server-environment': 'libtmux.Server:list_environment',
  'session-environment': 'libtmux.Entity:list_environment',
  'set-server-environment': 'libtmux.Server:set_environment',
  'set-session-environment': 'libtmux.Entity:set_environment',
  'unset-server-environment': 'libtmux.Server:unset_environment',
  'unset-session-environment': 'libtmux.Entity:unset_environment',
  'remove-server-environment': 'libtmux.Server:remove_environment',
  'remove-session-environment': 'libtmux.Entity:remove_environment',
  'show-buffer': 'libtmux.Server:show_buffer',
  'set-buffer': 'libtmux.Server:set_buffer',
  'delete-buffer': 'libtmux.Server:delete_buffer',
  snapshot: 'libtmux.Server:snapshot',
  'server-cmd': 'libtmux.Server:command',
  'search-sessions': 'libtmux.Server:query',
  'search-server-panes': 'libtmux.Server:query_panes',
  'session-id': 'libtmux.SnapshotSession.id',
  'window-id': 'libtmux.SnapshotWindow.id',
  'pane-id': 'libtmux.SnapshotPane.id',
  'session-name': 'libtmux.SnapshotSession.name',
  'window-name': 'libtmux.SnapshotWindow.name',
  'pane-index': 'libtmux.SnapshotPane.index',
  'window-height': 'libtmux.SnapshotWindow.height',
  'window-width': 'libtmux.SnapshotWindow.width',
  'pane-height': 'libtmux.SnapshotPane.height',
  'pane-width': 'libtmux.SnapshotPane.width',
  'pane-title': 'libtmux.SnapshotPane.title',
  'pane-active': 'libtmux.SnapshotPane.active',
  'session-attached': 'libtmux.SnapshotSession.attached',
  'session-created': 'libtmux.SnapshotSession.created',
  'session-path': 'libtmux.SnapshotSession.path',
  'session-window-count': 'libtmux.SnapshotSession.window_count',
  'window-pane-count': 'libtmux.SnapshotWindow.pane_count',
  'window-layout': 'libtmux.SnapshotWindow.layout',
  'pane-current-command': 'libtmux.SnapshotPane.current_command',
  'pane-current-path': 'libtmux.SnapshotPane.current_path',
  'pane-pid': 'libtmux.SnapshotPane.pid',
  'pane-tty': 'libtmux.SnapshotPane.tty',
  'pane-window-id': 'libtmux.SnapshotPane.window_id',
  'pane-window': 'libtmux.SnapshotPane.window',
  'resize-window': 'libtmux.Entity:resize',
  'respawn-window': 'libtmux.Entity:respawn',
  'link-window': 'libtmux.Entity:link',
  'move-window': 'libtmux.Entity:move',
  'swap-window': 'libtmux.Entity:swap',
  'break-pane': 'libtmux.Entity:break_out',
  'move-pane': 'libtmux.Entity:move_to',
  'swap-pane': 'libtmux.Entity:swap',
  'copy-mode': 'libtmux.Entity:copy_mode',
}
