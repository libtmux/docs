...
const LUA_CONCEPTS: Record<string, string> = {
  ...
  'split-pane': 'libtmux.Pane:split',
  'respawn-pane': 'libtmux.Pane:respawn',
  'clear-history': 'libtmux.Pane:clear_history',
  'set-pane-title': 'libtmux.Pane:set_title',
  'paste-buffer': 'libtmux.Pane:paste_buffer',
  'select-layout': 'libtmux.Window:layout',
  'unlink-window': 'libtmux.WindowLink:unlink',
  'new-session': 'libtmux.Server:new_session',
  'new-window': 'libtmux.Session:new_window',
  'kill-session': 'libtmux.Session:kill',
  'kill-window': 'libtmux.Window:kill',
  ...
  'rename-session': 'libtmux.Session:rename',
  'rename-window': 'libtmux.Window:rename',
  'select-window': 'libtmux.WindowLink:select',
  'select-pane': 'libtmux.Pane:select',
  'resize-pane': 'libtmux.Pane:resize',
  ...
  'session-option': 'libtmux.Session:get_option',
  'window-option': 'libtmux.Window:get_option',
  'pane-option': 'libtmux.Pane:get_option',
  'set-server-option': 'libtmux.Server:set_option',
  'set-session-option': 'libtmux.Session:set_option',
  'set-window-option': 'libtmux.Window:set_option',
  'set-pane-option': 'libtmux.Pane:set_option',
  'unset-server-option': 'libtmux.Server:unset_option',
  'unset-session-option': 'libtmux.Session:unset_option',
  'unset-window-option': 'libtmux.Window:unset_option',
  'unset-pane-option': 'libtmux.Pane:unset_option',
  'server-hooks': 'libtmux.Server:list_hooks',
  'session-hooks': 'libtmux.Session:list_hooks',
  'window-hooks': 'libtmux.Window:list_hooks',
  'pane-hooks': 'libtmux.Pane:list_hooks',
  'set-server-hook': 'libtmux.Server:set_hook',
  'set-session-hook': 'libtmux.Session:set_hook',
  'set-window-hook': 'libtmux.Window:set_hook',
  'set-pane-hook': 'libtmux.Pane:set_hook',
  'unset-server-hook': 'libtmux.Server:unset_hook',
  'unset-session-hook': 'libtmux.Session:unset_hook',
  'unset-window-hook': 'libtmux.Window:unset_hook',
  'unset-pane-hook': 'libtmux.Pane:unset_hook',
  'server-environment': 'libtmux.Server:list_environment',
  'session-environment': 'libtmux.Session:list_environment',
  'set-server-environment': 'libtmux.Server:set_environment',
  'set-session-environment': 'libtmux.Session:set_environment',
  'unset-server-environment': 'libtmux.Server:unset_environment',
  'unset-session-environment': 'libtmux.Session:unset_environment',
  'remove-server-environment': 'libtmux.Server:remove_environment',
  'remove-session-environment': 'libtmux.Session:remove_environment',
  ...
  'resize-window': 'libtmux.Window:resize',
  'respawn-window': 'libtmux.Window:respawn',
  'link-window': 'libtmux.WindowLink:link',
  'move-window': 'libtmux.WindowLink:move',
  'swap-window': 'libtmux.WindowLink:swap',
  'break-pane': 'libtmux.Pane:break_out',
  'move-pane': 'libtmux.Pane:move_to',
  'swap-pane': 'libtmux.Pane:swap',
  'copy-mode': 'libtmux.Pane:copy_mode',
}
